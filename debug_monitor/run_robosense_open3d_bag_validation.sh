...
RUN_DIR="${1:-/home/ubuntu/humanoid_ws/debug_monitor/robosense_open3d_validation_$(date +%Y%m%d_%H%M%S)}"
RATE="${RATE:-3.0}"
...
python3 "$WS/debug_monitor/analyze_robosense_open3d_validation.py" \
