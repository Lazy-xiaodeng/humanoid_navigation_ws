...
RUN_DIR="${1:-/home/ubuntu/humanoid_ws/debug_monitor/integrated_robosense_validation_$(date +%Y%m%d_%H%M%S)}"
RATE="${RATE:-3.0}"
OPEN3D_BASE="${OPEN3D_BASE:-/home/ubuntu/humanoid_ws/debug_monitor/robosense_open3d_validation_20260531_full}"
