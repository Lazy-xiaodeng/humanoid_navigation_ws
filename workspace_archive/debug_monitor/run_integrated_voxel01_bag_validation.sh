...
RUN_DIR="${1:-/home/ubuntu/humanoid_ws/workspace_archive/debug_monitor/integrated_voxel01_validation_$(date +%Y%m%d_%H%M%S)}"
RATE="${RATE:-3.0}"
...
python3 "$WS/workspace_archive/debug_monitor/make_integrated_ro_open3d_plots.py" \
  "$RUN_DIR" "$RUN_DIR"
