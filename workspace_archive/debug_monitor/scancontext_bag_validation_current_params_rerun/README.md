# scancontext_bag_validation_current_params_rerun
...
| 文件 | 用途 | 使用方法/注意事项 |
|---|---|---|
| `drift_recovery_analysis.md` | 历史设计、问题复盘、测试结论或使用说明文档；直接用 Markdown 阅读。 | 路径已归档到本目录；如脚本依赖绝对工作空间路径，保留原 `/home/ubuntu/humanoid_ws` 引用。 |
...
| `waypoints.csv` | 表格化采样/统计结果；可用表格软件、pandas 或脚本读取。 | 路径已归档到本目录；如脚本依赖绝对工作空间路径，保留原 `/home/ubuntu/humanoid_ws` 引用。 |
