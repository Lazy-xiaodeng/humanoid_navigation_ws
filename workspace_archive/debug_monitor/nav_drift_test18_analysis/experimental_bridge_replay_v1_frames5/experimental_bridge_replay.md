...
- protected simulated max jump: 0.942 m
- protected held candidates: 1753
- protected degraded events: 1241
- protected idle large accepts: 10
...
| 点位10 | 0.313 | 0.694 | 0.472 | 0.000 | 0 | False |
| 点位11 | 0.679 | 0.679 | 0.126 | 0.000 | 0 | False |
| 点位12 | 0.217 | 0.217 | 0.217 | 0.061 | 0 | False |
| 点位13 | 0.253 | 0.253 | 0.253 | 0.000 | 0 | False |
...
- 1780146282.724 idle dx=0.339 yaw=0.050 pending_age=0.39s
- 1780146534.730 idle dx=0.566 yaw=0.058 pending_age=0.40s
- 1780146811.535 idle dx=0.942 yaw=0.049 pending_age=60.20s
- 1780146887.251 idle dx=0.846 yaw=0.039 pending_age=0.41s
- 1780146894.934 idle dx=0.282 yaw=0.012 pending_age=0.40s
- 1780146954.035 idle dx=0.834 yaw=0.037 pending_age=0.40s
- 1780146984.740 idle dx=0.355 yaw=0.016 pending_age=0.41s
- 1780147044.243 idle dx=0.709 yaw=0.021 pending_age=0.40s
- 1780147136.256 idle dx=0.422 yaw=0.015 pending_age=0.40s
- 1780147219.255 idle dx=0.635 yaw=0.026 pending_age=0.41s
...
### 点位11
- 1780146711.861 hold_degraded nav_large_blocked dx=1.125 yaw=0.035 age=41.51s
- 1780146711.937 hold_degraded nav_large_blocked dx=1.125 yaw=0.035 age=41.59s
- 1780146712.026 hold_degraded nav_large_blocked dx=1.125 yaw=0.035 age=41.68s
- 1780146712.124 hold_degraded nav_large_blocked dx=1.125 yaw=0.035 age=41.78s
- 1780146712.223 hold_degraded nav_large_blocked dx=1.125 yaw=0.035 age=41.88s
...
- 1780146725.828 hold nav_large_blocked dx=0.525 yaw=0.023 age=0.00s
- 1780146725.930 hold nav_large_blocked dx=0.525 yaw=0.023 age=0.10s
- 1780146726.041 hold nav_large_blocked dx=0.525 yaw=0.023 age=0.21s
- 1780146726.138 hold nav_large_blocked dx=0.525 yaw=0.023 age=0.31s
- 1780146726.243 hold nav_large_blocked dx=0.525 yaw=0.023 age=0.41s
- 1780146726.338 hold nav_large_blocked dx=0.525 yaw=0.023 age=0.51s
- 1780146726.428 hold nav_large_blocked dx=0.525 yaw=0.023 age=0.60s
- 1780146732.349 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146732.438 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146732.536 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146732.634 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146732.745 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146732.839 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
### 点位13
...
- 1780146744.822 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146744.931 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.022 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.143 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.239 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.332 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.426 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.531 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.644 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.739 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.832 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146745.937 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146746.042 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146746.152 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
- 1780146746.253 reject spin_to_pose_freeze_tf dx=0.000 yaw=0.000 age=0.00s
### 点位14
