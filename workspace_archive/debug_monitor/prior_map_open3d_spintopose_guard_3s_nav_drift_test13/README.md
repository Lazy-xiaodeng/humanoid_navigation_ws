# prior_map_open3d_spintopose_guard_3s_nav_drift_test13
...
| 文件 | 用途 | 使用方法/注意事项 |
|---|---|---|
| `episodes.csv` | 表格化采样/统计结果；可用表格软件、pandas 或脚本读取。 | 路径已归档到本目录；如脚本依赖绝对工作空间路径，保留原 `/home/ubuntu/humanoid_ws` 引用。 |
