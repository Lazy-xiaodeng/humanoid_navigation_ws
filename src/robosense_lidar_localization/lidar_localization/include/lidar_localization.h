...
private:
  ...
  double MATCHING_CHECK_VALID_PAIR_RATIO_THRESH = 0.7;
  double MATCHING_CHECK_PRIOR_XY_THRESH = 0.5;
  double MATCHING_CHECK_PRIOR_Z_THRESH = 0.5;
  double MATCHING_CHECK_PRIOR_YAW_THRESH_DEG = 8.0;
