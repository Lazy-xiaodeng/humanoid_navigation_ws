...
def generate_launch_description():
    ...
    pkg_robosense_localization = get_package_share_directory('humanoid_robosense_localization_runtime')
    ...
    default_robosense_config_file = os.path.join(
        pkg_robosense_localization,
        'config',
    ...
    localization_ready_gate = nav2_cpp_node(
        'wait_for_tf',
