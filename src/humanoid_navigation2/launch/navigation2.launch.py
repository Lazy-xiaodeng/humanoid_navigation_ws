    ...
    scancontext_global_localizer_node = Node(
        ...
        parameters=[
            scancontext_params_file,
            {
                ...
                'global_recovery_gicp_fitness_threshold': 0.20,
                'global_recovery_required_consistent_results': 3,
                'global_recovery_consistency_window': 6,
                'global_recovery_consistency_xy_tolerance': 0.8,
                'global_recovery_consistency_yaw_tolerance': 0.35,
